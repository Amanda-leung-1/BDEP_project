...
# Define file names
file_daily <- "kge_nse_daily.csv"
file_weekly <- "kge_nse_weekly.csv"
file_monthly <- "kge_nse_monthly.csv"
file_irr <- "kge_nse_irr.csv"
file_seasonal <- "kge_nse_seasonal.csv"
...
file_metric_daily <- "Files/SMMR_Comparison_Results/metrics/metrics_daily.csv"
file_metric_weekly <- "Files/SMMR_Comparison_Results/metrics/metrics_weekly.csv"
file_metric_monthly <- "Files/SMMR_Comparison_Results/metrics/metrics_monthly.csv"
file_metric_irr <- "Files/SMMR_Comparison_Results/metrics/metrics_irr.csv"
file_metric_seasonal <- "Files/SMMR_Comparison_Results/metrics/metrics_seasonal.csv"
